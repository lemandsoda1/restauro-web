/* Inline Lucide-style icon set (ISC-licensed path data), so the app has no
   CDN/runtime dependency. 24×24, 1.6px stroke, rounded caps. */
...
export default function Icon({ name, size = 18, stroke = 1.6, style, className }) {
  const inner = PATHS[name] || PATHS["frame"];
  return (
    <svg
